...
if __name__ == "__main__":
    ...
    #     predpath = "../TestSet/Image/"
    #     maskpath = os.path.join("./0819pred",modelname)
    #
    #     device = "cuda"
    #     model = DenseNet2d(num_classes=3).to(device)
    #     print(modelroot)
