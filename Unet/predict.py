...
def PredAssample(model1,model2,predpicpath,masksavepath =None,device =None):
    ...
    for pic in piclist:
        ...
        outputarr = FindRegion(outputarr,900)
        outputarr = np.array(outputarr,dtype='uint8')
...
if __name__ == "__main__":
    # model1path = "./G_epoch100.pth"
    # model2path = "./models/G_epoch500.pth"
    # #predpath = "../TestSetWithTrueMask/Images/"
    # predpath = "../TestSetNoMask/Image/"
    # maskpath = "../TestSetNoMask/0820predPred/"
    # #predpath = "../TestSet/Image/"
    # #maskpath = "../TestSet/1150P378_/"
    # device = "cuda"
    # model1 = UNet(in_channel=1,n_classes=3)
    ...
    # PredictOneHot(model1,predpath,maskpath)
    ...
    for model in os.listdir(modelpath):
        ...
        predpath = "../TestSetNoMask/Image/"
        maskpath = os.path.join("../TestSetNoMask/KingDataUnet/",modelname)

        device = "cuda"
        model = UNet(in_channel=1,n_classes=3).to(device)
        print(modelroot)
