...
def train():
    ...
    # dataloader
    trainloader = data.DataLoader(BladderOneHot(imageroot="../../../0821/Data2200WithMoreAllDA/Image/",labelroot="../../../0821/Data2200WithMoreAllDA/Label/",img_transform=input_transform,label_transform=target_transform),batch_size=batchsize,shuffle=True)

    # model
    G = DenseUNet(in_size=1,num_classes=3).to(device)
